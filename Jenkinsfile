                ...
                stage('Test') {
                    steps {
                        container('podman') {
                            ...
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"tidyverse\");library(\"tidybayes\");library(\"rstan\");library(\"shinystan\");library(\"loo\");library(\"coda\");library(\"HDInterval\");library(\"testthat\");library(\"MASS\");library(\"palmerpenguins\");library(\"packrat\");library(\"cmdstanr\");library(\"rsconnect\");library(\"StanHeaders\");library(\"tidytext\");cmdstan_version()"'
