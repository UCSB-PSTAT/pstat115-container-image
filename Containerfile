...
RUN R -e "install.packages(c('tidyverse','tidybayes', 'rstan', 'shinystan', 'loo', 'coda', 'HDInterval', 'testthat', 'MASS', 'palmerpenguins', 'packrat', 'rsconnect', 'tidytext'), repos = 'https://cloud.r-project.org/', Ncpus = parallel::detectCores())"
